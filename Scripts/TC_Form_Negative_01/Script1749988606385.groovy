...
WebUI.scrollToElement(findTestObject('PracticeForm/Input-FirstName'), 5)

WebUI.setText(findTestObject('PracticeForm/Input-FirstName'), 'Sela')

WebUI.setText(findTestObject('PracticeForm/Input-LastName'), 'Agustina')

WebUI.setText(findTestObject('PracticeForm/Input-Email'), 'shelaagustina.gmail.com')

WebUI.click(findTestObject('PracticeForm/Gender-Female'))
...
WebUI.sendKeys(findTestObject('PracticeForm/Input-DOB'), '1999 August 14' + Keys.ENTER)
...
WebUI.click(findTestObject('PracticeForm/State/State-Haryana'))

WebUI.click(findTestObject('PracticeForm/City/City-Container'))

WebUI.click(findTestObject('PracticeForm/City/City-Karnal'))
...
WebUI.sendKeys(findTestObject('PracticeForm/Input-DOB'), '')
